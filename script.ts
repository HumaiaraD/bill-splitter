...
const tipPercent = document.getElementById('percent') as HTMLInputElement;
const perPerson = document.getElementById('person') as HTMLInputElement;
const checkBtn = document.getElementById('check-btn') as HTMLButtonElement;
const resultOne = document.getElementById('result1') as HTMLSpanElement;
const resultTwo = document.getElementById('result2') as HTMLSpanElement;
